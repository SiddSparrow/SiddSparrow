...
| [**Email Classifier**](https://github.com/SiddSparrow/personal_email_classifier) | Python, NLP, Gmail API, Telegram API | Email Classifier that Fetches Emails from Gmail and Sends Notifications via Telegram |
